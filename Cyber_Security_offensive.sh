...
function menu () {
    #install
    echo -e "\n ${RED}[!]${RESET} ${BOLD}Some downloads may fail – repeat step 4 until all are installed${RESET}\n"
    echo -e " ${YELLOW}[i]${RESET} ${BOLD}Install Menu – Choose steps in order:${RESET}\n"
    echo -e "   ${GREEN}[1]${RESET}  ${BOLD}Update and upgrade${RESET}"
    echo -e "   ${CYAN}[2]${RESET}  ${BOLD}Add Parrot tools to apt${RESET}"
    echo -e "   ${CYAN}[3]${RESET}  ${BOLD}Change PPA permissions manually${RESET}"
    echo -e "   ${CYAN}[4]${RESET}  ${BOLD}Update and upgrade again${RESET}"
    echo -e "   ${CYAN}[5]${RESET}  ${BOLD}Install tools${RESET}"
    echo -e "   ${CYAN}[6]${RESET}  ${BOLD}Clean system${RESET}"
    echo -e "   ${CYAN}[7]${RESET}  ${BOLD}Set folders permissions${RESET}\n"
